  ...
  <div class="main-wrapper">
      ...
      <div class="container single-col-max-width">
        ...
        <div id="pricing-tabs" class="pricing-tabs d-block d-md-none mb-3">
          <a
            ...
            data-tab-target="pricing-1-data"
            >Basic</a
          >
          <a href="#" class="pricing-tab mb-2" data-tab-target="pricing-2-data"
            >Standard</a
          >
          <a href="#" class="pricing-tab" data-tab-target="pricing-3-data"
            >Premium</a
          >
        </div>
        <!--//pricing-mobile-tabs-->
        ...
        <table id="pricing-table" class="pricing-table table-bordered">
          <thead>
            <tr class="border-0">
              ...
              <th
                scope="col"
                class="pricing-package-title pricing-data pricing-1-data"
              >
                Basic
              </th>
              <th
                scope="col"
                class="pricing-package-title pricing-data pricing-2-data mobile-is-hidden"
              >
                Standard
              </th>
              <th
                scope="col"
                class="pricing-package-title pricing-data pricing-3-data mobile-is-hidden"
              >
                Premium
              </th>
            </tr>
          ...
          <tbody>
            <tr class="pricing-price-row">
              ...
              <td class="pricing-data pricing-1-data">
                <span class="price-number">$900</span>
              </td>
              <td class="pricing-data pricing-2-data mobile-is-hidden">
                <span class="price-number">$2500</span>
              </td>
              <td class="pricing-data pricing-3-data mobile-is-hidden">
            ...
            <tr class="pricing-desc-row">
              ...
              <td class="pricing-data pricing-1-data">
                <span class="pricing-package-desc"
                  >A small app lorem ipsum dolor sit amet, consectetuer
                  adipiscing elit. Aenean commodo ligula eget dolor.</span
                >
              </td>
              <td class="pricing-data pricing-2-data mobile-is-hidden">
                <span class="pricing-package-desc"
                  >An medium app lorem ipsum dolor sit amet, consectetuer
                  adipiscing elit. Aenean commodo ligula eget dolor.</span
                >
              </td>
              <td class="pricing-data pricing-3-data mobile-is-hidden">
                <span class="pricing-package-desc"
                  >A complex app lorem ipsum dolor sit amet, consectetuer
                  adipiscing elit. Aenean commodo ligula eget dolor.</span
                >
              </td>
            </tr>
            ...
            <tr class="pricing-feature-row">
              <th class="pricing-feature-row-name pricing-0-data" scope="row">
                Feature Lorem<br /><small
                  class="feature-desc font-weight-normal text-muted"
                  >Optional feature description goes here. Lorem ipsum dolor sit
                  amet, consectetuer adipiscing elit.</small
                >
              </th>
              <td class="pricing-data pricing-1-data">
    ...
    <section class="faq-section">
      <div class="container single-col-max-width">
        ...
        <div
          id="faq-accordion"
          class="faq-accordion accordion mx-auto text-start"
        >
          <div class="accordion-item mb-3 rounded">
            <h2
              class="accordion-header border-0 px-4 py-3 rounded theme-bg-light"
              id="faq-heading-1"
            >
              <button
                ...
                aria-controls="faq1"
              >
                Can you sit amet quam eget lacinia?<i
          ...
          <div class="accordion-item mb-3 rounded">
            ...
            >
              <button
                ...
                aria-controls="faq2"
              >
                What is the ipsum dolor sit amet quam tortor?<i
                  class="fas fa-chevron-down"
                ></i>
              </button>
            </h2>
          ...
          <div class="accordion-item mb-3 rounded">
            ...
            >
              <button
                ...
                aria-controls="faq3"
              >
                What if ultricies nec vulputate eget?<i
                  class="fas fa-chevron-down"
                ></i>
              </button>
            </h2>
          ...
          <div class="accordion-item mb-3 rounded">
            ...
            >
              <button
                ...
                aria-controls="faq4"
              >
                Is it possible to tellus eget auctor condimentum?<i
                  class="fas fa-chevron-down"
                ></i>
              </button>
            </h2>
          ...
          <div class="accordion-item mb-3 rounded">
            ...
            >
              <button
                ...
                aria-controls="faq5"
              >
                Do you elementum turpis semper imperdiet?<i
                  class="fas fa-chevron-down"
                ></i>
              </button>
            </h2>
          ...
          <div class="accordion-item mb-3 rounded">
            ...
            >
              <button
                ...
                aria-controls="faq6"
              >
                How much imperdiet lorem sem non nisl?<i
                  class="fas fa-chevron-down"
                ></i>
              </button>
            </h2>
          ...
          <div class="accordion-item mb-3 rounded">
            ...
            >
              <button
                ...
                aria-controls="faq7"
              >
                How long does it take to imperdiet lorem sem non nisl?<i
                  class="fas fa-chevron-down"
                ></i>
              </button>
            </h2>
          ...
          <div class="accordion-item mb-3 rounded">
            ...
            >
              <button
                ...
                aria-controls="faq8"
              >
                Where can I imperdiet lorem sem non nisl?<i
                  class="fas fa-chevron-down"
                ></i>
              </button>
            </h2>
          ...
          <div class="accordion-item mb-3 rounded">
            ...
            >
              <button
                ...
                aria-controls="faq9"
              >
                When can lacinia ac dui ut semper?<i
                  class="fas fa-chevron-down"
                ></i>
              </button>
            </h2>
