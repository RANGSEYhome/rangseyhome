            ...
            <div class="col-12 col-md-7 col-lg-8 col-xxl-9">
              <div class="client-info">
                ...
                <ul class="client-meta list-unstyled">
                  <li class="mb-2">
                    <i class="fas fa-industry fa-fw me-2"></i
                  ...
                  <li class="mb-2">
                    <strong
                      ><i class="fas fa-link fa-fw me-2"></i>Website:</strong
                    >
              ...
              <div class="row">
                <div class="metric col-6 col-xl-3 mb-3">
                  <div class="inner p-3 theme-bg-light">
                    ...
                    <div class="metric-data mb-2">
                      20% <span class="unit">up</span>
                    </div>
